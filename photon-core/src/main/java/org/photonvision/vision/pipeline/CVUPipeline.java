...
public abstract class CVUPipeline<R extends CVUPipelineResult, S extends CVPipelineSettings>
    ...
    public CVUPipeline(FrameThresholdType thresholdType) {
    ...
    protected abstract R process(UFrame frame, S settings);
    ...
    public R run(UFrame frame, QuirkyCamera cameraQuirks) {
        if (released) {
